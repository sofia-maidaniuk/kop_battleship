 ...
 * @description Сторінка Політики конфіденційності (Privacy Policy).
 * Містить вичерпну інформацію про обробку даних користувача відповідно до стандартів GDPR.
 * Пояснює використання Local Storage, Cookies та права користувача в межах додатка.
 */
 ...
 * * @component
 * @description Рендерить текстовий документ політики конфіденційності.
 * Оскільки додаток працює виключно на стороні клієнта (Client-side),
 * цей документ фокусується на прозорості локального збереження даних.
 * * @returns {JSX.Element} Сторінка з структурованим текстом політики та кнопкою повернення.
 */
    ...
    return (
        <div className={styles.page}>
            <div className={styles.contentCard}>
                ...
                <p className={styles.text}>All data is stored locally in your browser. Data remains stored until you clear your browser cookies or Local Storage.</p>

                <h2 className={styles.sectionTitle}>7. Your Rights Under GDPR</h2>
                <p className={styles.text}>Since all data is stored locally, you can exercise your rights directly by clearing your browser data.</p>
